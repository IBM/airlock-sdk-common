...
public class PercentageManager {
    ...
    public PercentageManager(CacheManager cacheManager) {
        this.persistenceHandler = cacheManager.getPersistenceHandler();
        this.streamsManager = cacheManager.getStreamsManager();
    ...
    public Double getPercentage(Sections section, String name) {
        String sectionName;
