...
public class BasicEntitlementsTest extends BaseTestModel {
    ...
    public void testParseDefaultEntitlementSectionTest() throws Exception {
        Entitlement entitlement = testHelper.getManager().getEntitlement("purchase.P1");
    ...
    public void testMergeEntitlementBranchWithVariantEntShouldBeOff() throws Exception {
        ...
        Entitlement entitlement = testHelper.getManager().getEntitlement("airlockEntitlement.Pr4Br1");
        Assert.assertNotNull(entitlement);
        ...
        testHelper.pull();
        testHelper.calcSync(null, (JSONObject) null);
        entitlement = testHelper.getManager().getEntitlement("purchase.P1");
        Assert.assertNotNull(entitlement);
        Assert.assertTrue(!entitlement.isOn());

        entitlement = testHelper.getManager().getEntitlement("airlockEntitlement.Pr4Br1");
        Assert.assertNotNull(entitlement);
    ...
    public void testEntitlementOptionsCalculationCondition() throws Exception {
        ...
        Entitlement p5 = testHelper.getManager().getEntitlement("airlockEntitlement.P5");
        ...
        Entitlement p4 = testHelper.getManager().getEntitlement("airlockEntitlement.P4");
    ...
    public void testMergeDevelopmentBranchNewOption() throws Exception {
        testHelper.pull();
        testHelper.calcSync(null, (JSONObject) null);
        Entitlement entitlement = testHelper.getManager().getEntitlement("airlockEntitlement.P3");
        Assert.assertNotNull(entitlement);
        Assert.assertTrue(entitlement.isOn());
        Assert.assertTrue(entitlement.getPercentage() == 100);
        ...
        testHelper.pull();
        testHelper.calcSync(null, (JSONObject) null);
        entitlement = testHelper.getManager().getEntitlement("airlockEntitlement.P3");
        Assert.assertNotNull(entitlement);
        Assert.assertTrue(entitlement.getPercentage() == 100);
    ...
    public void testMergeDevelopmentBranchNewOptionMovedToAnotherParent() throws Exception {
        testHelper.pull();
        testHelper.calcSync(null, (JSONObject) null);
        Entitlement entitlement = testHelper.getManager().getEntitlement("airlockEntitlement.P6");
        Assert.assertNotNull(entitlement);
        ...
        testHelper.pull();
        testHelper.calcSync(null, (JSONObject) null);
        entitlement = testHelper.getManager().getEntitlement("airlockEntitlement.P6");
        Assert.assertNotNull(entitlement);
        Assert.assertTrue(entitlement.getPercentage() == 100);
        Collection<PurchaseOption> purchaseOptions = entitlement.getPurchaseOptions();
        Assert.assertTrue(entitlement.getPurchaseOptions().size() == 0);

        entitlement = testHelper.getManager().getEntitlement("airlockEntitlement.P8");
    ...
    public void testMergeDevelopmentBranchEntitlementPurchaseShouldbe50() throws Exception {
        testHelper.pull();
        testHelper.calcSync(null, (JSONObject) null);
        Entitlement entitlement = testHelper.getManager().getEntitlement("purchase.P2");
        Assert.assertNotNull(entitlement);
        Assert.assertTrue(entitlement.isOn());
        Assert.assertTrue(entitlement.getPercentage() == 100);
        ...
        testHelper.pull();
        testHelper.calcSync(null, (JSONObject) null);
        entitlement = testHelper.getManager().getEntitlement("purchase.P2");
        Assert.assertNotNull(entitlement);
    ...
    public void testFeatureIsPremiumAndPurchased() throws Exception {
        testHelper.pull();
        testHelper.calcWithProductIdsAndSync(null, purchasedProductId);
        Feature f1 = testHelper.getManager().getFeature("ns1.F1");
        Assert.assertTrue(f1.isOn());
        Assert.assertTrue(f1.isPremium());
        Assert.assertTrue(f1.isPurchased());
        Feature f2 = testHelper.getManager().getFeature("ns1.F2");
        ...
        f1 = testHelper.getManager().getFeature("ns1.F1");
        Assert.assertTrue(!f1.isOn());
        Assert.assertTrue(f1.isPremium());
        Assert.assertFalse(f1.isPurchased());
        f2 = testHelper.getManager().getFeature("ns1.F2");
        Assert.assertTrue(!f2.isOn());
        Assert.assertTrue(f2.isPremium());
        Assert.assertFalse(f2.isPurchased());
    }
    ...
    @Test
    public void testPremiumFallBackValueShouldBeLastCalcResults() throws Exception {
        testHelper.pull();
        testHelper.calcWithProductIdsAndSync(null, purchasedProductId);
        Feature f1 = testHelper.getManager().getFeature("ns1.F1");
        Assert.assertTrue(f1.isOn());
        ...
        Feature f21 = testHelper.getManager().getFeature("ns1.F21");
        Assert.assertTrue(f21.isOn());
        Assert.assertFalse(f21.isPremium());
        Assert.assertTrue(f21.isPurchased());

        //set invalid premium rule
        JSONObject featureConfig = new JSONObject(testHelper.getManager().
                getPersistenceHandler().read(Constants.SP_RAW_RULES, "{}"));
        JSONObject invalidPremimumRule = new JSONObject();
        invalidPremimumRule.put("ruleString", "[1,1,1].includes(1)");

        // set F1 be invalid rule
        featureConfig.getJSONObject("root").getJSONArray("features").getJSONObject(0).
                put("premiumRule", invalidPremimumRule);

        // set F21 be invalid rule
        featureConfig.getJSONObject("root").getJSONArray("features").getJSONObject(1).
                getJSONArray("features").getJSONObject(0).
                put("premiumRule", invalidPremimumRule);
        testHelper.getManager().
                getPersistenceHandler().write(Constants.SP_RAW_RULES, featureConfig);
        testHelper.calcWithProductIdsAndSync(null, purchasedProductId);
        ...
        // should be the same
        f21 = testHelper.getManager().getFeature("ns1.F21");
        Assert.assertTrue(f21.isOn());
        Assert.assertFalse(f21.isPremium());
        Assert.assertTrue(f21.isPurchased());
    }
    ...
    public void testPremiumFeatureInMutexShouldCountOnIsPurchasedCondition() throws Exception {
        testHelper.pull();
        testHelper.calcWithProductIdsAndSync(null, purchasedProductId);
        Feature f3 = testHelper.getManager().getFeature("ns3.F3");
    ...
    public void testEntitlementPurchaseAreOFFOrDisabledShouldHaveAnyConfig() throws Exception {
        testHelper.pull();
        testHelper.calcWithProductIdsAndSync(null, purchasedProductId);
        Entitlement entitlement = testHelper.getManager().getEntitlement("airlockEntitlement.P10");
        Assert.assertTrue(entitlement.getPurchaseOptions().size() == 2);
        Collection<PurchaseOption> purchaseOptions = entitlement.getPurchaseOptions();
    ...
    public void testGetPurchasedEntitlementsListShouldReturnListOfPurchasedEntitlements() throws Exception {
        testHelper.pull();
        testHelper.calcWithProductIdsAndSync(null, purchasedProductId);
        Collection<Entitlement> entitlements = testHelper.getManager().getPurchasedEntitlements(purchasedProductId);
    ...
    public void testEntitlementBranchInMXShouldHaveOneElementOn() throws Exception {
        testHelper.pull();
        testHelper.calcWithProductIdsAndSync(null, purchasedProductId);
        Entitlement entitlement = testHelper.getManager().getEntitlement("airlockEntitlement.P11");
        ...
        entitlement = testHelper.getManager().getEntitlement("airlockEntitlement.P11");
        Assert.assertTrue(entitlement.getEntitlementChildren().size() == 3);
        for (Entitlement child : entitlement.getEntitlementChildren()) {
    ...
    public void testEntitlementsAnalyticsReport() throws Exception {
        testHelper.pull();
        testHelper.calcWithProductIdsAndSync(null, purchasedProductId);
        Entitlement entitlement = testHelper.getManager().getEntitlement("airlockEntitlement.P12");
