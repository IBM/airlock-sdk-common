    ...
    public void mapItem(JSONObject in, Map<String, JSONObject> out, boolean useId) throws JSONException {
        ...
        if (purchaseOptions != null) {
            for (int i = 0; i < purchaseOptions.length(); ++i) {
                ...
                super.mapItem(purchasOption, out, useId);
            }
        }
    }

    protected void resolvePurchaseOptions(JSONObject override, Map<String, JSONObject> nameMap, String nameKey, String childKey) throws Exception {
