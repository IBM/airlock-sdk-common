...
public class FeaturesCalculator {
    ...
    protected static String getMutexId(JSONObject obj) // using mx.uniqueId
    {
     ...
     */
    public JSONObject calculate(CacheManager cacheManager, @Nullable JSONObject features,
            ...
            JSONException,
            ScriptInitException {
        return calculate(cacheManager, features, context, functions, translations, userGroups, fallback, productVersion, featureRandomNumber, null, null);
    }
     ...
     * @throws JSONException On case of initialization exception - this exception will be thrown
     */
    public JSONObject calculate(@Nullable CacheManager cacheManager, @Nullable JSONObject features,
                                @Nullable JSONObject context,
                                String functions,
                                JSONObject translations,
                                @Nullable List<String> userGroups,
        ...
        ScriptInvoker invoker = createJsObjects(cacheManager == null ? null : cacheManager.getAirlockContextManager(),
    ...
    protected Result checkPreconditions(JSONObject obj, AdditionalData additionalData) {
        if (!isEnabled(obj)) {
    ...
    private int processCalculableChild(JSONObject obj, ScriptInvoker invoker, AdditionalData additionalData, ConfigResult out) throws
        ...
        Configuration.mergeJson(out.attributes, attributes);
    ...
    static class AdditionalData {
        ...
        AdditionalData(List<String> profileGroups,
