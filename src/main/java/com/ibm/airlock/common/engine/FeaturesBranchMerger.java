...
public class FeaturesBranchMerger {
    ...
    protected Feature.BranchStatus getBranchStatus(JSONObject obj) throws JSONException {
    ...
    protected JSONObject merge(@Nullable JSONObject clonedMaster, @Nullable Map<String, JSONObject> nameMap, JSONObject branch) throws MergeException {
    ...
    protected boolean isRoot(JSONObject override) {
    ...
    protected void mergeRootNames(JSONObject override, JSONObject clonedMaster) throws JSONException {
    ...
    void overrideItem(JSONObject out, JSONObject override, Map<String, JSONObject> nameMap) throws Exception {
    ...
    protected void markForDeletion(JSONObject override, Map<String, JSONObject> nameMap) throws JSONException {
        if (getBranchStatus(override) == Feature.BranchStatus.CHECKED_OUT) {
    ...
    protected void markChildren(JSONObject override, Map<String, JSONObject> nameMap, String childKey) throws JSONException {
    ...
    protected void removeResiduals(JSONObject item) throws JSONException {
        removeChidren(item, getChildrenName());
        removeChidren(item, Constants.JSON_FEATURE_FIELD_CONFIGURATION_RULES);
    }

    protected void removeChidren(JSONObject item, String childKey) throws JSONException {
    ...
    protected void mergeDelta(JSONObject override, Map<String, JSONObject> nameMap) throws JSONException {
