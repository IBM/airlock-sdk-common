...
public class StateFullContext {
    ...
    private Script mergeDeepFunction;
    private final String contextVarName;
    private ReentrantReadWriteLock reentrantReadWriteLock = new ReentrantReadWriteLock(true);

    // o2 overrides o1
    private final static String jsonMergeMethod = "function mergeDeep (o1, o2) { \n" +
            "               var tempNewObj = o1; \n" +
            "            \n" +
            "               //if o1 is an object - {} \n" +
    ...
    public StateFullContext(String contextVarName) {
        ...
        this.mergeDeepFunction = rhino.compileString(jsonMergeMethod + " ; var " + this.contextVarName + " = {};", "mergeDeep", 1, null);
    ...
    public void update(String context, Boolean clearPreviousContext) {
        if (!clearPreviousContext) {
            ...
            try {
                ...
                SafeContextFactory safeContextFactory = new SafeContextFactory();
                Context rhino = safeContextFactory.makeContext().enter();
                rhino.evaluateString(scope, this.contextVarName + " = " + context.toString(), "<cmd>", 1, null);
            } finally {
